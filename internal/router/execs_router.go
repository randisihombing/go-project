...
func execsRouter() *http.ServeMux {
	...
	mux.HandleFunc("POST /execs/forgotpassword", handler.ForgotPasswordHandler)
	mux.HandleFunc("POST /execs/resetpassword/reset/{resetcode}", handler.ResetPasswordHandler)
